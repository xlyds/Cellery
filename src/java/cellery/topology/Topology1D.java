...
/**
 * An object that specifies how a {@link java.cellery.CellArray1D} should retrieve neighborhoods. This object specifies the
 * size and geometry of neighborhoods in the client CellArray2D and specifies an identity space over the client.
 * @see {@link Base}, {@link Space}, {@link java.cellery.CellArray1D}, {@link java.cellery.Automaton1D},
 * @author Zach Tidwell
 */
...
public class Topology1D {
	 ...
	 * Each item has a field containing the appropriate method name in {@link java.cellery.CellArray1D} so that a
	...
	public static enum Base {
		...
		/**
		 * A symmetrical region about a {@link java.cellery.Cell}
		 */
		RADIAL ("radial"),
		
		/**
		 * The region contiguous region to the left of a {@link java.cellery.Cell}
		 */
		LEFT ("leftOf"),
		
		/**
		 * The contiguous region to the right of a {@link java.cellery.Cell}
		 */
		RIGHT ("rightOf");
	...
	/**
	 * Creates a Topology1D object that specifies how a {@link java.cellery.CellArray1D} should retrieve neighborhoods. The given Basis specifies the
	...
	* Provides Identity functions to map i coordinate of the client {@link java.cellery.CellArray1D} according to this specification.
	* @author Zach Tidwell
	* @see {@link Topology1D.Space Spaces}, {@link java.cellery.CellArray1D CellArray1D}
	*/
	public final static class Standard {
	
		/**
		* The identify function that maps the i value of the client {@link java.cellery.CellArray1D} to the {@link Standard} identification space.
		* @see {@link Space}
	...
	* Provides Identity functions to map i coordinates of the client {@link java.cellery.CellArray1D} according to this specification.
	* @author Zach Tidwell
	* @see {@link Topology1D.Space Spaces}, {@link java.cellery.CellArray1D CellArray1D}
	*/
	public final static class Circle {
		/**
		 * The identify function that maps the j value of the client {@link java.cellery.CellArray1D} to the {@link Circle} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray1D.
