...
public class OrthTests {
	...
	public void test() {
		...
		int expectedh002 = 1;
		int actualh002 = test.getHorizontal(0, 0, 2);
		assertEquals(expectedh002, actualh002);

		int expectedh111 = 1;
		int actualh111 = test.getHorizontal(1, 1, 1);
		assertEquals(expectedh111, actualh111);

		int expectedh221 = 0;
		int actualh221 = test.getHorizontal(2, 2, 1);
		assertEquals(expectedh221, actualh221);

		int expectedv111 = 1;
		int actualv111 = test.getVertical(1, 1, 1);
		assertEquals(expectedv111, actualv111);

		int expectedv112 = 1;
		int actualv112 = test.getVertical(1, 1, 2);
		assertEquals(expectedv112, actualv112);

		int expectedv001 = 1;
		int actualv001 = test.getVertical(0, 0, 1);
		assertEquals(expectedv001, actualv001);

		int expectedv221 = 0;
		int actualv221 = test.getVertical(2, 2, 1);
