...
/**
 * An object that specifies how a {@link CellArray1D} should retrieve neighborhoods. This object specifies the 
 * size and geometry of neighborhoods in the client CellArray2D and specifies an identity space over the client.
 * @see {@link Base}, {@link Space}, {@link CellArray1D}, {@link Automaton1D}, 
 * @author Zach Tidwell
 */
...
public class Topology1D {
	 ...
	 * {@link topology.Topology1D.Base#RADIAL radial}, 
	 * {@link topology.Topology2D.Base#LEFT left},
	 * {@link topology.Topology2D.Base#RIGHT right},
	...
	public static enum Base {
		...
		/**
		 * A symmetrical region about a {@link Cell}
		 */
		RADIAL ("radial"),
		
		/**
		 * The region contiguous region to the left of a {@link Cell}
		 */
		LEFT ("leftOf"),
		
		/**
		 * The contiguous region to the right of a {@link Cell}
		 */
		RIGHT("rightOf");
	...
	/**
	 * An enumeration of the supported identity spaces: {@link topology.Topology1D.Space#STD Standard}, 
	 * {@link topology.Topology1D.Space#CIRC Circle}
	 ...
	 * {@link topology.Topology1D.Space#getTau getTau()} method.
	 * @author Zach Tidwell
	 */
	...
	/**
	 * Creates a Topology1D object that specifies how a {@link CellArray1D} should retrieve neighborhoods. The given Basis specifies the 
	 * geometry of the neighborhood. The supported neighborhood geometries are enumerated in {@link Topology21.Base}. Moreover, 
	 ...
	 * @param basis The {@link topology.Topology1D.Base neighborhood} geometry selected for this topology
	 * @param coarseness sets the size of the neighborhoods about a given {@link Cell}.
	 * @param space The {@link topology.Topology1D.Space identification space} associated with this Topology.
	 */
	...
	* @author Zach Tidwell
	* @see {@link topology.Topology1D.Space Spaces}, {@link cellery.CellArray1D CellArray1D}
	*/
	public final static class Standard {
		...
		*/
		public final static int idI(int i, int length){
			return i;
		}
	...
	*/
	public final static class Circle {
		/**
		 * The identify function that maps the j value of the client {@link CellArray1D} to the {@link Cylinder} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray1D.
		 * @param length of the CellArra12D.
		 * @return the mapped i value
		 */
		public final static int idI(int i, int length){
			if ( i < 0 ){
