...
/**
 * An object that specifies how a {@link CellArray2D} should retrieve neighborhoods. This object specifies the 
 * size and geometry of neighborhoods in the client CellArray2D and specifies an identity space over the client.
 * @see {@link Base}, {@link Space}, {@link CellArray2D}, {@link Automaton2D}, 
 * @author Zach Tidwell
 */
public class Topology2D{
	 ...
	 * {@link topology.Topology2D.Base#MOORE Moore}, 
	 * {@link topology.Topology2D.Base#VON_NEUMANN Von Neumann},
	 * {@link topology.Topology2D.Base#LEFT_CORNER Left Corners},
	 * {@link topology.Topology2D.Base#RIGHT_CORNER Right Corners},
	 * {@link topology.Topology2D.Base#HORIZONTAL Horizontal},
	 * {@link topology.Topology2D.Base#VERTICAL_2D Vertical},
	 * {@link topology.Topology2D.Base#LEFT_DIAGONAL Left Diagonal},
	 * {@link topology.Topology2D.Base#RIGHT_DIAGONAL Right Diagonal}.
	 * Each item has a field containing the appropriate method name in {@link CellArray2D} so that a 
	...
	/**
	 * An enumeration of the supported identity spaces: {@link topology.Topology2D.Space#STD Standard}, 
	 * {@link topology.Topology2D.Space#CYL Cylinder}, {@link topology.Topology2D.Space#MOEB Moebius Band}.
	 ...
	 * {@link topology.Topology2D.Space#getTau getTau()} method.
	 * @author Zach Tidwell
	 */
	public static enum Space {
		//TODO: Add support for Tori and Klein Bottles
		...
		/**
		 * Toroidal quotient space topology on a rectrangular subset of R^2.
		 */
		TOR ("Torus"),
	...
	/**
	 * Creates a Topology2D object that specifies how a {@link CellArray2D} should retrieve neighborhoods. The given Basis specifies the 
	 ...
	 * @param basis The {@link topology.Topology2D.Base neighborhood} geometry selected for this topology
	 * @param coarseness sets the size of the neighborhoods about a given {@link Cell}.
	 * @param space The {@link topology.Topology2D.Space identification space} associated with this Topology.
	 */
	...
	/**
	 * The first identify function which maps the row index "i" of the target {@link CellArray2D} as specified by this {@link Topology2D}.
	 * @param x
	 * @param y
	 * @param length
	 * @param width
	 ...
	 * Provides Identity functions to map (i, j) coordinates of the client {@link CellArray2D} according to this specification. 
	 * @author Zach Tidwell
	 * @see {@link topology.Topology2D.Space Spaces}, {@link cellery.CellArray2D CellArray2D}
	 */
	public final static class Standard {
		
		/**
		 * The identify function that maps the i value of the client {@link CellArray2D} to the {@link Standard} identification space.
		 * @see {@link Space}
		 ...
		 */
		public final static int idI(int i, int j, int length, int width){
			return i;
		}
		
		/**
		 * The identify function that maps the j value of the client {@link CellArray2D} to the {@link Cylinder} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray2D.
		 * @param j The column index of the CellArray2D.
		 * @param length of the CellArray2D.
		 ...
		 */
		public final static int idJ(int i, int j, int length, int width){
			return j;
		}
	}
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	 ...
	 * {@link CellArray2D} according to this specification. 
	 * @author Zach Tidwell
	 * @see {@link topology.Topology2D.Space Spaces}, {@link cellery.CellArray2D CellArray2D}
	 *
	 */
	public final static class Cylinder {
		...
		/**
		 * The identify function that maps the i value of the client {@link CellArray2D} to the {@link Cylinder} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray2D.
		 * @param j The column index of the CellArray2D.
		 * @param length of the CellArray2D.
	 ...
	 * of the client {@link CellArray2D} according to this specification. 
	 * @author Zach Tidwell
	 * @see {@link topology.Topology2D.Space Spaces}, {@link cellery.CellArray2D CellArray2D}
	 */
	public final static class Torus {
		...
		/**
		 * The identify function that maps the i value of the client {@link CellArray2D} to the {@link Torus} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray2D.
		 * @param j The column index of the CellArray2D.
		 * @param length of the CellArray2D.
		...
		/**
		 * The identify function that maps the j value of the client {@link CellArray2D} to the {@link Torus} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray2D.
		 * @param j The column index of the CellArray2D.
		 * @param length of the CellArray2D.
	...
	public final static class Moebius {
		...
		/**
		 * The identify function that maps the i value of the client {@link CellArray2D} to the {@link Moebius} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray2D.
		 * @param j The column index of the CellArray2D.
		 * @param length of the CellArray2D.
		...
		/**
		 * The identify function that maps the j value of the client {@link CellArray2D} to the {@link Moebius} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray2D.
		 * @param j The column index of the CellArray2D.
		 * @param length of the CellArray2D.
	...
	public final static class Klein {
		...
		/**
		 * The identify function that maps the i value of the client {@link CellArray2D} to the {@link Klein} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray2D.
		 * @param j The column index of the CellArray2D.
		 * @param length of the CellArray2D.
		...
		/**
		 * The identify function that maps the j value of the client {@link CellArray2D} to the {@link Klein} identification space.
		 * @see {@link Space}
		 * @param i The row index of the CellArray2D.
		 * @param j The column index of the CellArray2D.
		 * @param length of the CellArray2D.
