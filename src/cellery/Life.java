...
/**
 * {@link CellularAutomata2D} endowed with the Game of Life rules
 * @author Zach Tidwell
 *
 */
public class Life extends CellularAutomata2D {
	/**
	 * Constructs a {@link CellularAutomata2D} imbued with the Game of Life rules.
	 * @param cells The first generation
	 */
