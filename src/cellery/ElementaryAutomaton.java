...
import rules.ElementaryRule;
import rules.Rule;

/**
 * A 2-state {@link Automaton1D} controlled by Stephen Wolfram's 256 Elementary Automation Rules.
 * The Rules for this Automaton are governed by the byte-codes enumerated in {@link rules.ElementaryRule}.
...
public class ElementaryAutomaton extends Automaton1D {
	 ...
	 * {@link rules.ElementaryRule}
	 * @param cells A {@link CellArray1D} that provides the initial state of this 
	 * @param E A {@link rules.ElementaryRule} representing the Wolfram Code that governs the evolution of this.
	 */
	...
	/**
	 * Resets the current {@link rules.ElementaryRule} with the on provided.
	 * @param E The new {@link rules.ElementaryRule}
	 */
