 ...
 * of the CellArray that underlies the client cellery.Automaton.
...
public class Rule {
	 ...
	 * of the cardinality of the neighborhood that is specified for the cellery.Automaton by its underlying
	 * @param B an array 
	 * @param S
	 * 
	 */
