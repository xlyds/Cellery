...
/**
 * cellery.CellArray1D is a 1-d array of {@link Cell} objects which can kill or resurrect Cells and
...
public class CellArray1D {
	...
	/**
	 * Initializes a {@link Cell}[] from an integer array. A living cellery.Cell is placed in the index corresponding
	 ...
	 * cellery.Cell at position i
	 * @param i the position of the cellery.Cell
	...
	/**
	 * Retrieves the {@link CellArray1D} containing the {@link Cell}s about the i-th cellery.Cell in a
	 ...
	 * 1 indicates that the cellery.Cell is alive and 0 indicates that it is dead.
	 ...
	 * @return the cellery.Cell at position i.
	 */
